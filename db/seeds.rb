...
Scope.create(description: "Install stairs", extra: true, estimated_hours: 120, hours: 80, value: 3500, estimated_gc_due_date: 1.week.ago.to_date, actual_gc_due_date: 5.days.ago.to_date, job_id: Job.first.id, department_id: Department.first.id, scope_number: "M3", notes: "None")
Scope.create(description: "Install railing", extra: false, estimated_hours: 100, hours: 100, value: 3000, estimated_gc_due_date: 2.weeks.ago.to_date, actual_gc_due_date: 3.days.ago.to_date, job_id: Job.second.id, department_id: Department.second.id, scope_number: "M1", notes: "Get done quick")
